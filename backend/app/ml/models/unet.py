"""U-Net model for wall segmentation in floorplans"""
import torch
...
class UNet(nn.Module):
    """
    U-Net architecture for wall segmentation in floorplans
    
    Args:
        n_channels: Number of input channels (3 for RGB, 1 for grayscale)
        n_classes: Number of output classes (2 for binary segmentation: wall/background)
...
def create_unet(n_channels: int = 3, n_classes: int = 2, pretrained: bool = False) -> UNet:
    """
